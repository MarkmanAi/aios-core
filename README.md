# MarkmanAi AIOS: Framework Universal de Agentes IA 🚀
...
O MarkmanAi AIOS segue uma hierarquia clara de prioridades:
...
**As Duas Inovações Chave do MarkmanAi AIOS:**
...
> ⚠️ **Estes diagramas explicam 90% da confusão sobre o fluxo MarkmanAi AIOS Agentic Agile** - Entender a criação de PRD+Arquitetura e o fluxo de trabalho sm/dev/qa e como os agentes passam notas através de arquivos de histórias é essencial - e também explica por que isto NÃO é taskmaster ou apenas um simples executor de tarefas!
...
```bash
npx github:MarkmanAi/aios-core install
```
...
**Instale o MarkmanAi AIOS com um único comando:**
...
O MarkmanAi AIOS agora inclui uma experiência de instalação interativa de última geração, inspirada em ferramentas modernas como Vite e Next.js:
...
O MarkmanAi AIOS inclui regras pré-configuradas para IDE para melhorar sua experiência de desenvolvimento:
...
O MarkmanAi AIOS oferece uma CLI moderna e cross-platform com comandos intuitivos:
...
npx aios-core uninstall   Remover MarkmanAi AIOS
```
...
✔ MarkmanAi AIOS installed successfully
```
...
MarkmanAi AIOS: AI-Orchestrated System for Full Stack Development
...
git clone https://github.com/MarkmanAi/aios-core.git
cd aios-core
...
npx github:MarkmanAi/aios-core setup
...
O framework de linguagem natural do AIOS funciona em QUALQUER domínio. Os Squads fornecem agentes IA especializados para escrita criativa, estratégia de negócios, saúde e bem-estar, educação e muito mais. Além disso, os Squads podem expandir o núcleo do MarkmanAi AIOS com funcionalidade específica que não é genérica para todos os casos. [Veja o Guia de Squads](docs/guides/squads-guide.md) e aprenda a criar os seus próprios!

## Agentes Disponíveis

O MarkmanAi AIOS vem com 11 agentes especializados:
...
O MarkmanAi AIOS v1.0.0 introduz o **Autonomous Development Engine (ADE)** - um sistema completo para desenvolvimento autônomo que transforma requisitos em código funcional.
...
- **[hybrid-ops](https://github.com/MarkmanAi/aios-hybrid-ops-pedro-valerio)** - Operações híbridas humano-agente (repositório separado)

## Suporte & Comunidade

- 📖 [Guia da Comunidade](docs/community.md) - Como participar e contribuir
- 💬 [Discussões GitHub](https://github.com/MarkmanAi/aios-core/discussions) - Hub central da comunidade
- 💡 [Processo de Features](docs/FEATURE_PROCESS.md) - Como propor novas funcionalidades
- 🐛 [Rastreador de Issues](https://github.com/MarkmanAi/aios-core/issues)
...
O MarkmanAi AIOS implementa um sistema de validação de múltiplas camadas para garantir qualidade do código e consistência:
...
[![Contributors](https://contrib.rocks/image?repo=MarkmanAi/aios-core)](https://github.com/MarkmanAi/aios-core/graphs/contributors)
