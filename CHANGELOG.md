...
All notable changes to MarkmanAi AIOS will be documented in this file.
...
- **Rebranding to Synkra** (OSR-9)
  ...
  - Namespace updated to MarkmanAi
...
- **Private expansion packs** - Moved to separate private repository (`aios-expansion-packs`)
  ...
  - Repository: https://github.com/MarkmanAi/aios-expansion-packs (PRIVATE)
- **Internal development tools** - Moved to separate private repository (`aios-dev-tools`)
  ...
  - Repository: https://github.com/MarkmanAi/aios-dev-tools (PRIVATE)
- **hybrid-ops expansion pack** - Moved to separate repository for independent maintenance
  ...
  - Repository: https://github.com/MarkmanAi/aios-hybrid-ops-pedro-valerio
...
- Breaking Change: hybrid-ops no longer bundled with @markmanai/aios-core
...
- Prevents confusion when running `npx @markmanai/aios-core install` from home directory

### Changed
- Early exit with `process.exit(1)` when NPX temporary context detected
- Help message provides actionable solution: `cd /path/to/your/project && npx @markmanai/aios-core install`
