...
This directory contains workflow definitions for the MarkmanAi AIOS framework. Workflows define multi-step processes that can be executed by AIOS agents.
