...
Publishing: my-squad@1.0.0
  ...
  Target: github.com/MarkmanAi/aios-squads
...
Pull Request Created!
  URL: https://github.com/MarkmanAi/aios-squads/pull/42
  Branch: squad/my-squad
...
4. Create/check fork
   └── Fork MarkmanAi/aios-squads if needed
