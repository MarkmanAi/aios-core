...
This directory contains tool integration definitions for MarkmanAi AIOS agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
