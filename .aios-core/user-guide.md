# Guia do Usuário MarkmanAi AIOS

## Visão Geral

O MarkmanAi AIOS é um framework de desenvolvimento full stack orientado por agentes de IA que implementa uma metodologia ágil única. Este guia explica como usar o MarkmanAi AIOS de forma eficaz através de suas duas fases principais: **Planejamento** e **Desenvolvimento**.
...
npx @markmanai/aios-core@rc install
...
```bash
# Clone o repositório
git clone https://github.com/MarkmanAi/aios-core
cd @markmanai/aios-core
...
npx @markmanai/aios-core@rc install --force-upgrade
...
npm view @markmanai/aios-core@rc version
# Output: 1.0.0-rc.10

# Ver agentes disponíveis
npx @markmanai/aios-core@rc list:agents

# Ver expansion packs
npx @markmanai/aios-core@rc list:expansions

# Ajuda do instalador
npx @markmanai/aios-core@rc install --help
```
...
npx @markmanai/aios-core@1.0.0-rc.10 install --force-upgrade
```
...
O MarkmanAi AIOS usa uma abordagem de duas fases que separa planejamento estratégico de implementação tática:
...
O agente **qa** do MarkmanAi AIOS inclui capacidades avançadas de arquitetura de testes:
...
O MarkmanAi AIOS permite configurar preferências técnicas que influenciam decisões dos agentes:
...
```bash
# No repositório @markmanai/aios-core
@github-devops
*detect-repo
# Output:
# Repository: github.com/MarkmanAi/aios-core
...
Ao integrar MarkmanAi AIOS em projetos existentes:
...
O MarkmanAi AIOS inclui meta-agentes para orquestração:
...
O MarkmanAi AIOS suporta expansion packs para domínios específicos:
...
### Suporte
- [GitHub Issues](https://github.com/MarkmanAi/aios-core/issues)
...
*MarkmanAi AIOS User Guide v2.0*
