# MarkmanAi AIOS Development Rules for Gemini CLI

You are working with MarkmanAi AIOS, an AI-Orchestrated System for Full Stack Development.

## Core Framework Understanding

MarkmanAi AIOS is a meta-framework that orchestrates AI agents to handle complex development workflows. Always recognize and work within this architecture.
...
---
*MarkmanAi AIOS Gemini CLI Configuration v1.0*
