...
|------------|---------|------|----------|
| `MarkmanAi/aios-core` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `MarkmanAi/aios-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
| `MarkmanAi/mcp-ecosystem` | Apache 2.0 | Public | Docker MCP, IDE configs, MCP presets |
| `MarkmanAi/mmos` | Proprietary + NDA | Private | MMOS Minds, DNA Mental |
| `MarkmanAi/certified-partners` | Proprietary | Private | Premium squads, partner portal |
...
│                                                                         │
│   MarkmanAi/aios-core        MarkmanAi/aios-squads                   │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
│                                                                         │
│   MarkmanAi/mmos             MarkmanAi/certified-partners            │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
