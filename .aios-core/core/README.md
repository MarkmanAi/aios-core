...
> Central runtime module providing essential framework functionality for MarkmanAi AIOS.
...
The core module is automatically available within the MarkmanAi AIOS framework:
...
*MarkmanAi AIOS Core Module v2.0.0*
