# MarkmanAi AIOS Meta-Agent Troubleshooting Guide

## Overview

This guide helps diagnose and resolve common issues when using the MarkmanAi AIOS meta-agent for component creation and management.
...
3. Check working directory:
   ```bash
   pwd
   # Should be in @markmanai/aios-core root
   ```
