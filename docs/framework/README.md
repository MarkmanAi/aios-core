...
**Migration Target:** Q2 2026 → `MarkmanAi/aios-core` repository
...
**⚠️ IMPORTANT**: These documents are now in the `MarkmanAi/aios-core` repository. The migration from the old `aios/aios-core` org was completed in December 2024 as part of OSR-9 (Rebranding).

### Migration Timeline

- **Phase 1 (Q1 2026 - Story 6.1.2.6):** ✅ Framework docs separated into `docs/framework/`
- **Phase 2 (Q4 2024):** ✅ Repository migrated to `MarkmanAi/aios-core` (OSR-9)
...
- **Lifecycle**: Lives in `MarkmanAi/aios-core` repository
