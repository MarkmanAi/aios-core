...
| npm Packages    | `@markmanai/aios-core` | `@aios/core`         | Update package.json     |
...
**Cause:** Package scope changed from `@markmanai` to `@aios`
...
2. Search [existing issues](https://github.com/MarkmanAi/aios-core/issues)
3. Open a [new issue](https://github.com/MarkmanAi/aios-core/issues/new) with the `migration` label
4. Join the [Discussions](https://github.com/MarkmanAi/aios-core/discussions) for community help
