# Comunidade MarkmanAi AIOS

> 🇺🇸 [English Version](COMMUNITY.md)

Bem-vindo à comunidade MarkmanAi AIOS!
...
4. Apresente-se nas [Discussões](https://github.com/MarkmanAi/aios-core/discussions)

### Encontre Sua Primeira Contribuição

- Procure issues marcadas com [`good-first-issue`](https://github.com/MarkmanAi/aios-core/labels/good-first-issue)
- Verifique [`help-wanted`](https://github.com/MarkmanAi/aios-core/labels/help-wanted) para tarefas mais complexas
- Navegue pelas [Discussões abertas](https://github.com/MarkmanAi/aios-core/discussions) para ajudar outros
...
[Participe da Discussão](https://github.com/MarkmanAi/aios-core/discussions)

### Rastreador de Issues

Para relatórios de bugs e solicitações de funcionalidades:

- [Issues do aios-core](https://github.com/MarkmanAi/aios-core/issues) - Framework principal
- [Issues do aios-squads](https://github.com/MarkmanAi/aios-squads/issues) - Squads AIOS
- [Issues do mcp-ecosystem](https://github.com/MarkmanAi/mcp-ecosystem/issues) - Ferramentas MCP
...
- Listados em nossa [página de Contribuidores](https://github.com/MarkmanAi/aios-core/graphs/contributors)
...
- [@MarkmanAi](https://github.com/MarkmanAi) - Líder do Projeto
...
Todos os contribuidores são reconhecidos em nossa [página de Contribuidores](https://github.com/MarkmanAi/aios-core/graphs/contributors).
...
Reporte violações para: conduct@MarkmanAi.com
...
2. Pesquise [Discussões existentes](https://github.com/MarkmanAi/aios-core/discussions)
3. Pergunte nas Discussões de Q&A
4. Abra uma discussão de Troubleshooting

### Encontrou um bug?

1. Pesquise [issues existentes](https://github.com/MarkmanAi/aios-core/issues)
2. Se for novo, [abra um relatório de bug](https://github.com/MarkmanAi/aios-core/issues/new?template=bug_report.md)

### Tem uma ideia?

1. Verifique se existe em [Ideias](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas)
2. Se for nova, [compartilhe sua ideia](https://github.com/MarkmanAi/aios-core/discussions/new?category=ideas)
...
- [Projeto GitHub](https://github.com/orgs/MarkmanAi/projects/1) - Quadro de rastreamento detalhado

O roadmap é atualizado mensalmente e reflete a contribuição da comunidade. Você pode influenciar nossa direção por:

1. **Votando** em ideias nas [Discussões](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas)
...
- [Organização AIOS no GitHub](https://github.com/MarkmanAi)
...
- Versão Atual: Veja [releases](https://github.com/MarkmanAi/aios-core/releases)
