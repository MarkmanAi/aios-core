...
Levamos a segurança a sério na MarkmanAi. Se você descobrir uma vulnerabilidade de segurança no AIOS, por favor reporte de forma responsável.
...
1. **GitHub Security Advisories** (Preferido)
   - Vá para [Security Advisories](https://github.com/MarkmanAi/aios-core/security/advisories)
