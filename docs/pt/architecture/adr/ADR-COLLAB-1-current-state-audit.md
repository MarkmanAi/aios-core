...
**Fonte:** `gh api repos/MarkmanAi/aios-core/branches/main/protection`
...
**Fonte:** `gh api repos/MarkmanAi/aios-core`
...
**Fonte:** `gh api repos/MarkmanAi/aios-core/actions/workflows`
