...
- `@MarkmanAi/maintainers` - Maintainers gerais (acesso de escrita)
- `@MarkmanAi/core-team` - Desenvolvedores core do framework
- `@MarkmanAi/devops` - CI/CD e infraestrutura
