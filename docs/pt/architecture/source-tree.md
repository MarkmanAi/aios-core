...
**Aviso de Migração:** Este documento será migrado para o repositório `MarkmanAi/aios-core` no Q2 2026 (veja Decisão 005)
...
│
├── bin/                               # Executáveis CLI
│   ├── @markmanai/aios-core.js              # Ponto de entrada principal da CLI
...
| 1.1    | 2025-12-14 | Atualizado org para MarkmanAi, substituído Squads pelo sistema Squads [Story 6.10] | Dex (dev)        |
