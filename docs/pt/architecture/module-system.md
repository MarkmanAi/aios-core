...
> Guia completo para a arquitetura modular v2.1 do MarkmanAi AIOS.
...
O MarkmanAi AIOS organiza o diretório `.aios-core/` em quatro módulos principais:
...
_Arquitetura do Sistema de Módulos MarkmanAi AIOS v2.1_
