...
### MarkmanAi/mmos (Proprietário + NDA)
...
### MarkmanAi/certified-partners (Proprietário)
...
git submodule add https://github.com/MarkmanAi/aios-squads.git squads

# Adicionar ecossistema MCP como submódulo
git submodule add https://github.com/MarkmanAi/mcp-ecosystem.git mcp
```
