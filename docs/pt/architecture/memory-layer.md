...
Esta é uma nova implementação MVP da camada de memória para MarkmanAi AIOS, projetada como uma prova de conceito leve que pode ser facilmente integrada com o sistema de agentes existente. O MVP usa LlamaIndex com armazenamento local para minimizar a complexidade de configuração.
