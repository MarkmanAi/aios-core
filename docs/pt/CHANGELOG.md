...
Todas as alteracoes notaveis do MarkmanAi AIOS serao documentadas neste arquivo.
...
- Processo de instalacao manual (use `npx @markmanai/aios-core install` em vez disso)
...
- Lancamento publico inicial do MarkmanAi AIOS
