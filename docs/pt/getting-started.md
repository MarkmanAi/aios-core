...
# Começando com o MarkmanAi AIOS

> 🌐 [EN](../getting-started.md) | **PT** | [ES](../es/getting-started.md)

---

Bem-vindo ao MarkmanAi AIOS! Este guia irá orientá-lo nos seus primeiros passos com o framework de desenvolvimento auto-modificável alimentado por IA.
...
Antes de instalar o MarkmanAi AIOS, certifique-se de ter:
...
npx @markmanai/aios-core init my-first-project
...
O MarkmanAi AIOS oferece opções flexíveis de instalação:

```bash
# 1. Criar novo projeto com template personalizado
npx @markmanai/aios-core init my-project --template enterprise
...
npx @markmanai/aios-core init my-project --force
...
O meta-agent é o núcleo do MarkmanAi AIOS - uma IA que entende e pode modificar sua própria base de código.
...
- **[Tutoriais em Vídeo](https://@markmanai/aios-core.dev/tutorials)**: Aprendizado visual
...
Lembre-se: O MarkmanAi AIOS aprende e melhora com o uso. Quanto mais você interagir com ele, melhor ele entenderá seu estilo e necessidades de desenvolvimento.

Bom código com o MarkmanAi AIOS!
