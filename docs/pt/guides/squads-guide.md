...
│  Nível 2: AIOS-SQUADS  → github.com/MarkmanAi (Público/Free) │
│  Nível 3: MARKMANAI API   → api.markmanai.com      (Marketplace)  │
└─────────────────────────────────────────────────────────────┘
```
...
| -------------------------------------------------------------------------- | ------ | ---------------------------------- |
| [etl-squad](https://github.com/MarkmanAi/aios-squads/tree/main/etl)         | 2.0.0  | Coleta e transformação de dados    |
| [creator-squad](https://github.com/MarkmanAi/aios-squads/tree/main/creator) | 1.0.0  | Utilitários de geração de conteúdo |
...
Isso cria um PR para [MarkmanAi/aios-squads](https://github.com/MarkmanAi/aios-squads).

### Nível 3: MarkmanAi Marketplace
...
3. Re-publicar: `*publish-squad` ou `*sync-squad-markmanai`
...
- **Nível 3**: Sincronize com flag `--private`: `*sync-squad-markmanai my-squad --private`
...
- [Repositório aios-squads](https://github.com/MarkmanAi/aios-squads)

---

## Obtendo Ajuda

- [GitHub Discussions](https://github.com/MarkmanAi/aios-core/discussions)
- [Issue Tracker](https://github.com/MarkmanAi/aios-core/issues)
