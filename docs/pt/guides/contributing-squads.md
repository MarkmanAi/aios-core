...
2. **MarkmanAi Marketplace** - Squads premium via API MarkmanAi
...
Isso irá:
1. Fazer fork de `MarkmanAi/aios-squads` (se necessário)
...
## Publicando no MarkmanAi Marketplace
...
- **Perguntas**: [GitHub Discussions](https://github.com/MarkmanAi/aios-core/discussions)
