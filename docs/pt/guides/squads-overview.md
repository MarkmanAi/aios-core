...
| ----------------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0  | Coleta e transformação de dados    | [aios-squads/etl](https://github.com/MarkmanAi/aios-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0  | Utilitários de geração de conteúdo | [aios-squads/creator](https://github.com/MarkmanAi/aios-squads/tree/main/creator) |
...
│  Nível 2: AIOS-SQUADS  --> github.com/MarkmanAi (Público)     │
...
- **Explore Squads Oficiais:** Confira o [repositório aios-squads](https://github.com/MarkmanAi/aios-squads)
- **Contribua:** Veja o [Guia de Contribuição de Squads](./contributing-squads.md)
- **Aprenda o Formato de Task:** Leia [TASK-FORMAT-SPECIFICATION-V1](../../../.aios-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificação de Formato de Task](../../../.aios-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_AIOS Squads: Equipes de agentes de IA trabalhando com você_
