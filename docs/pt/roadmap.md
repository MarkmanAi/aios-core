...
> Para rastreamento detalhado, veja nosso [Projeto GitHub](https://github.com/orgs/MarkmanAi/projects/1)
...
Reaja com :+1: em [Ideias nas Discussões](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas) existentes para mostrar apoio.

### 2. Proponha Features

Tem uma nova ideia? Abra uma [Discussão de Ideia](https://github.com/MarkmanAi/aios-core/discussions/new?category=ideas) para compartilhar com a comunidade.
...
5. Comunicar mudanças significativas via [Anúncios](https://github.com/MarkmanAi/aios-core/discussions/categories/announcements)
...
|-----------------|---------------------|
| [Projeto GitHub](https://github.com/orgs/MarkmanAi/projects/1) | `docs/stories/backlog.md` |
