...
# Guia de Solução de Problemas do MarkmanAi AIOS

> 🌐 [EN](../troubleshooting.md) | **PT** | [ES](../es/troubleshooting.md)

---

Este guia abrangente ajuda você a diagnosticar e resolver problemas comuns com o MarkmanAi AIOS.
...
2. **Colete informações:**
   ...
   - Versão do AIOS: `npx @markmanai/aios-core version`
...
- **Stack Overflow**: Marque perguntas com `@markmanai/aios-core`
...
1. Executar `npx @markmanai/aios-core init test`
