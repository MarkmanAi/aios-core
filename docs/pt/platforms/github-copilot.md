...
Este projeto usa MarkmanAi AIOS para desenvolvimento orquestrado por IA.
...
Você é um Desenvolvedor Full Stack Sênior trabalhando com MarkmanAi AIOS.
...
*MarkmanAi AIOS - Guia da Plataforma GitHub Copilot v1.0*
