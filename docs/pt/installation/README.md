...
# Documentação de Instalação do MarkmanAi AIOS
...
Este diretório contém documentação abrangente de instalação e configuração para o MarkmanAi AIOS.
...
3. Abra uma [Issue no GitHub](https://github.com/MarkmanAi/aios-core/issues)
