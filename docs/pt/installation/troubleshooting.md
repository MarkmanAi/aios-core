...
### Problema 1: "npx @markmanai/aios-core is not recognized"
...
1. Execute `npx @markmanai/aios-core status` e anote a saída
2. Consulte este guia de solução de problemas
3. Pesquise [Issues existentes no GitHub](https://github.com/MarkmanAi/aios-core/issues)
