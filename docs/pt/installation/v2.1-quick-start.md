# Guia de Início Rápido AIOS v2.1
...
npx @markmanai/aios-core@latest init meu-projeto
cd meu-projeto
```
...
```bash
npx @markmanai/aios-core@latest doctor
```
...
```bash
# Instalação e setup
npx @markmanai/aios-core@latest           # Executar wizard
npx @markmanai/aios-core@latest doctor    # Executar diagnósticos
npx @markmanai/aios-core@latest info      # Mostrar info do sistema
...
npx @markmanai/aios-core@latest install
...
- **Documentação:** [Repositório GitHub](https://github.com/MarkmanAi/aios-core)
- **GitHub Issues:** [github.com/MarkmanAi/aios-core/issues](https://github.com/MarkmanAi/aios-core/issues)
