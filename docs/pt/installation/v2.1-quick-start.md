...
```bash
# Instalação e setup
npx @synkra/aios-core@latest           # Executar wizard
npx @synkra/aios-core@latest doctor    # Executar diagnósticos
npx @synkra/aios-core@latest info      # Mostrar info do sistema
