...
# Guia de Atualização do MarkmanAi AIOS

> 🌐 [EN](../migration-guide.md) | **PT** | [ES](../es/migration-guide.md)

---

Este guia ajuda você a atualizar entre versões do MarkmanAi AIOS.
...
**MarkmanAi AIOS v4.4.0** (Versão Estável Atual)
...
2. **Issues no GitHub**: [github.com/MarkmanAi/aios-core/issues](https://github.com/MarkmanAi/aios-core/issues)
