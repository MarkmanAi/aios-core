...
**Destino de Migração:** Q2 2026 → repositório `MarkmanAi/aios-core`
...
**IMPORTANTE**: Estes documentos agora estão no repositório `MarkmanAi/aios-core`. A migração do antigo org `aios/aios-core` foi concluída em dezembro de 2024 como parte do OSR-9 (Rebranding).

### Cronograma de Migração

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Docs do framework separados em `docs/framework/`
- **Fase 2 (Q4 2024):** Repositório migrado para `MarkmanAi/aios-core` (OSR-9)
...
- **Ciclo de vida**: Vive no repositório `MarkmanAi/aios-core`
