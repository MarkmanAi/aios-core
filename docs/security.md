...
We take security seriously at MarkmanAi. If you discover a security vulnerability in AIOS, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to [Security Advisories](https://github.com/MarkmanAi/aios-core/security/advisories)
