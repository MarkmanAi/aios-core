# MarkmanAi AIOS Troubleshooting Guide

> 🌐 **EN** | [PT](./pt/troubleshooting.md) | [ES](./es/troubleshooting.md)

---

This comprehensive guide helps you diagnose and resolve common issues with MarkmanAi AIOS.
...
```bash
# Basic diagnostic
npx @markmanai/aios-core doctor

# Auto-fix common issues
npx @markmanai/aios-core doctor --fix

# Verbose output
npx @markmanai/aios-core doctor --verbose

# Check specific component
npx @markmanai/aios-core doctor --component memory-layer
```
...
npx @markmanai/aios-core update
```
...
# Or use npm directly
npm exec @markmanai/aios-core init my-project
```
...
npx @markmanai/aios-core init my-project --skip-install
...
npx @markmanai/aios-core doctor --component config
...
cd C:\
npx @markmanai/aios-core init myapp
```
...
```
Error: "@markmanai/aios-core" cannot be opened
```
...
xattr -d com.apple.quarantine /usr/local/bin/@markmanai/aios-core
```
...
npx @markmanai/aios-core doctor --report diagnostic.json

# Include system info
npx @markmanai/aios-core info --detailed >> diagnostic.json
...
1. **Run diagnostics:**
   ```bash
   npx @markmanai/aios-core doctor --verbose > diagnostic.log
   ```
...
2. **Collect information:**
   ...
   - AIOS version: `npx @markmanai/aios-core version`

3. **Check existing issues:**
   - [GitHub Issues](https://github.com/@markmanai/aios-core/@markmanai/aios-core/issues)
   - [Discussions](https://github.com/@markmanai/aios-core/@markmanai/aios-core/discussions)
...
- **Stack Overflow**: Tag questions with `@markmanai/aios-core`
...
## Steps to Reproduce
1. Run `npx @markmanai/aios-core init test`
...
1. `npx @markmanai/aios-core doctor --fix`
2. Clearing caches
