...
> For detailed tracking, see our [GitHub Project](https://github.com/orgs/MarkmanAi/projects/1)
...
React with :+1: on existing [Ideas in Discussions](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas) to show support.

### 2. Propose Features

Have a new idea? Open an [Idea Discussion](https://github.com/MarkmanAi/aios-core/discussions/new?category=ideas) to share it with the community.
...
5. Communicate significant changes via [Announcements](https://github.com/MarkmanAi/aios-core/discussions/categories/announcements)
...
|----------------|-------------------|
| [GitHub Project](https://github.com/orgs/MarkmanAi/projects/1) | `docs/stories/backlog.md` |
