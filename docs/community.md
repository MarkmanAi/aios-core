# MarkmanAi AIOS Community

> 🇧🇷 [Versão em Português](COMMUNITY-PT.md)

Welcome to the MarkmanAi AIOS community!
...
4. Introduce yourself in [Discussions](https://github.com/MarkmanAi/aios-core/discussions)

### Find Your First Contribution

- Look for issues labeled [`good-first-issue`](https://github.com/MarkmanAi/aios-core/labels/good-first-issue)
- Check [`help-wanted`](https://github.com/MarkmanAi/aios-core/labels/help-wanted) for more complex tasks
- Browse [open Discussions](https://github.com/MarkmanAi/aios-core/discussions) to help others

## Communication Channels

### GitHub Discussions (Primary)

Our main communication hub for all AIOS repositories:

- **Announcements** - Project updates from maintainers
- **General** - General discussions about AIOS
...
[Join the Discussion](https://github.com/MarkmanAi/aios-core/discussions)

### Issue Tracker

For bug reports and feature requests:

- [aios-core Issues](https://github.com/MarkmanAi/aios-core/issues) - Core framework
- [aios-squads Issues](https://github.com/MarkmanAi/aios-squads/issues) - AIOS Squads
- [mcp-ecosystem Issues](https://github.com/MarkmanAi/mcp-ecosystem/issues) - MCP tools
...
- Listed in our [Contributors page](https://github.com/MarkmanAi/aios-core/graphs/contributors)
...
- [@MarkmanAi](https://github.com/MarkmanAi) - Project Lead
...
All contributors are recognized in our [Contributors page](https://github.com/MarkmanAi/aios-core/graphs/contributors).
...
Report violations to: conduct@MarkmanAi.com
...
2. Search [existing Discussions](https://github.com/MarkmanAi/aios-core/discussions)
3. Ask in Q&A Discussions
4. Open a Troubleshooting discussion

### Found a bug?

1. Search [existing issues](https://github.com/MarkmanAi/aios-core/issues)
2. If new, [open a bug report](https://github.com/MarkmanAi/aios-core/issues/new?template=bug_report.md)

### Have an idea?

1. Check if it exists in [Ideas](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas)
2. If new, [share your idea](https://github.com/MarkmanAi/aios-core/discussions/new?category=ideas)
...
- [GitHub Project](https://github.com/orgs/MarkmanAi/projects/1) - Detailed tracking board

The roadmap is updated monthly and reflects community input. You can influence our direction by:

1. **Voting** on ideas in [Discussions](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas)
...
- [AIOS GitHub Organization](https://github.com/MarkmanAi)
...
- Current Version: See [releases](https://github.com/MarkmanAi/aios-core/releases)
