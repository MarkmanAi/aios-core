# MarkmanAi AIOS Installation Documentation
...
This directory contains comprehensive installation and setup documentation for MarkmanAi AIOS.
...
2. Search [FAQ](./faq.md)
3. Open a [GitHub Issue](https://github.com/MarkmanAi/aios-core/issues)
