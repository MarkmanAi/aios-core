...
### Issue 1: "npx @markmanai/aios-core is not recognized"
...
1. Run `npx @markmanai/aios-core status` and note the output
2. Check this troubleshooting guide
3. Search existing [GitHub Issues](https://github.com/MarkmanAi/aios-core/issues)
...
- **GitHub Issues**: [@markmanai/aios-core/issues](https://github.com/MarkmanAi/aios-core/issues)
