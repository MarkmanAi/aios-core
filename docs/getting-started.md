# Getting Started with MarkmanAi AIOS

> 🌐 **EN** | [PT](./pt/getting-started.md) | [ES](./es/getting-started.md)

---

Welcome to MarkmanAi AIOS! This guide will walk you through your first steps with the AI-powered self-modifying development framework.
...
Before installing MarkmanAi AIOS, ensure you have:
...
MarkmanAi AIOS offers flexible installation options:
...
The meta-agent is the core of MarkmanAi AIOS - an AI that understands and can modify its own codebase.
...
- **[Video Tutorials](https://@markmanai/aios-core.dev/tutorials)**: Visual learning
...
Remember: MarkmanAi AIOS learns and improves with use. The more you interact with it, the better it understands your development style and needs.

Happy coding with MarkmanAi AIOS! 🚀