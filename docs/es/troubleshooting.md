...
# Guia de Solucion de Problemas de MarkmanAi AIOS

> 🌐 [EN](../troubleshooting.md) | [PT](../pt/troubleshooting.md) | **ES**

---

Esta guia completa te ayuda a diagnosticar y resolver problemas comunes con MarkmanAi AIOS.
...
2. **Recopilar informacion:**
   ...
   - Version de AIOS: `npx @markmanai/aios-core version`
...
- **Stack Overflow**: Etiqueta preguntas con `@markmanai/aios-core`
...
1. Ejecutar `npx @markmanai/aios-core init test`
