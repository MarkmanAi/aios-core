...
# Documentación de Instalación de MarkmanAi AIOS
...
Este directorio contiene documentación completa de instalación y configuración para MarkmanAi AIOS.
...
3. Abra un [Issue en GitHub](https://github.com/MarkmanAi/aios-core/issues)
