...
npx @markmanai/aios-core@latest init mi-proyecto
cd mi-proyecto
```
...
```bash
# Instalación y setup
npx @markmanai/aios-core@latest           # Ejecutar wizard
npx @markmanai/aios-core@latest doctor    # Ejecutar diagnósticos
npx @markmanai/aios-core@latest info      # Mostrar info del sistema
...
- **Documentación:** [Repositorio GitHub](https://github.com/MarkmanAi/aios-core)
