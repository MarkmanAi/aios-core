...
# Guía de Solución de Problemas de MarkmanAi AIOS
...
### Problema 1: "npx @markmanai/aios-core no se reconoce"
...
MarkmanAi AIOS should be installed in your project directory,
...
```
Error: MarkmanAi AIOS requires Node.js 18.0.0 or higher
...
```
npm ERR! code E404
npm ERR! 404 Not Found - GET https://registry.npmjs.org/@markmanai/aios-core
```
...
npm ERR! network request to https://registry.npmjs.org/@markmanai/aios-core failed
```
...
npm install @markmanai/aios-core --verbose
```
...
npx @markmanai/aios-core install --verbose
```
...
1. Ejecute `npx @markmanai/aios-core status` y anote la salida
2. Revise esta guía de solución de problemas
3. Busque [Issues de GitHub](https://github.com/MarkmanAi/aios-core/issues) existentes
...
- **Issues de GitHub**: [@markmanai/aios-core/issues](https://github.com/MarkmanAi/aios-core/issues)
