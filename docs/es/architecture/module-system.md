...
> Guía completa de la arquitectura modular v2.1 para MarkmanAi AIOS.
...
MarkmanAi AIOS organiza el directorio `.aios-core/` en cuatro módulos principales:
...
_Arquitectura del Sistema de Módulos MarkmanAi AIOS v2.1_
