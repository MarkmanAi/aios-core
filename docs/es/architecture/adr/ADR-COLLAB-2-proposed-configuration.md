...
Siguiendo la [Auditoria de Estado Actual](./ADR-COLLAB-1-current-state-audit.md), este documento propone cambios de configuracion especificos para habilitar contribuciones externas seguras a AIOS.
...
```bash
gh api repos/MarkmanAi/aios-core/branches/main/protection -X PUT \
...
# Configuracion CodeRabbit para AIOS
# Historia: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.aios-core/development/agents/**':
      - 'Verificar que el agente sigue la estructura YAML de agentes AIOS (persona_profile, commands, dependencies)'
    ...
    '.aios-core/development/tasks/**':
      - 'Verificar que la tarea sigue el formato de tareas AIOS con puntos de elicitacion claros'
    ...
    '.aios-core/product/templates/**':
      - 'Asegurar que la plantilla sigue las convenciones de plantillas AIOS'
    ...
    '**/*.js':
      ...
      - 'Asegurar que el codigo sigue los estandares de codigo AIOS'
...
# ============================================
* @MarkmanAi/maintainers

# ============================================
# Framework Core
# ============================================
# Definiciones de agentes - requiere revision del equipo core
.aios-core/development/agents/ @MarkmanAi/core-team

# Definiciones de tareas - requiere revision del equipo core
.aios-core/development/tasks/ @MarkmanAi/core-team

# Definiciones de workflows - requiere revision del equipo core
.aios-core/development/workflows/ @MarkmanAi/core-team

# Plantillas - requiere revision de arquitecto/equipo core
.aios-core/product/templates/ @MarkmanAi/core-team
templates/ @MarkmanAi/core-team

# Utilidades core - requiere revision senior
.aios-core/core/ @MarkmanAi/core-team
.aios-core/cli/ @MarkmanAi/core-team

# ============================================
# Infraestructura
# ============================================
# CI/CD - requiere aprobacion de devops
.github/ @MarkmanAi/devops

# Configuraciones de Docker
.docker/ @MarkmanAi/devops

# Archivos de configuracion
.aios-core/core-config.yaml @MarkmanAi/core-team
package.json @MarkmanAi/maintainers
package-lock.json @MarkmanAi/maintainers

# ============================================
# Documentacion (Mas Permisiva)
# ============================================
# Documentacion general - mantenedores pueden aprobar
docs/ @MarkmanAi/maintainers

# Decisiones de arquitectura - requiere equipo core
docs/architecture/ @MarkmanAi/core-team
docs/framework/ @MarkmanAi/core-team

# Historias - mantenedores (documentacion de desarrollo interno)
docs/stories/ @MarkmanAi/maintainers

# Guias - mantenedores (amigable para contribuidores)
docs/guides/ @MarkmanAi/maintainers

# ============================================
# Archivos Sensibles de Seguridad
# ============================================
# Configuraciones de seguridad
.github/CODEOWNERS @MarkmanAi/core-team
.github/workflows/semantic-release.yml @MarkmanAi/devops
.github/workflows/npm-publish.yml @MarkmanAi/devops

# Archivos de configuracion raiz
.env* @MarkmanAi/core-team
*.config.js @MarkmanAi/maintainers
```

**Equipos de GitHub Requeridos:**

- `@MarkmanAi/maintainers` - Mantenedores generales (acceso de escritura)
- `@MarkmanAi/core-team` - Desarrolladores core del framework
- `@MarkmanAi/devops` - CI/CD e infraestructura
...
- [ ] El agente sigue la estructura YAML de agentes AIOS
...
- [ ] La tarea sigue el formato de tareas AIOS
...
gh api -X DELETE repos/MarkmanAi/aios-core/branches/main/protection
...
echo "* @MarkmanAi" > .github/CODEOWNERS
