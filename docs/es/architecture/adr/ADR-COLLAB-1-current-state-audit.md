...
**Fuente:** `gh api repos/MarkmanAi/aios-core/branches/main/protection`
...
**Fuente:** `gh api repos/MarkmanAi/aios-core`
...
**Fuente:** `gh api repos/MarkmanAi/aios-core/actions/workflows`
