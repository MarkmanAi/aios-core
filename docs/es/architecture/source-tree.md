...
│
├── bin/                               # Ejecutables CLI
│   ├── @markmanai/aios-core.js           # Punto de entrada principal del CLI
...
### REPO 4: MarkmanAi/certified-partners (Privado)
...
### REPO 5: MarkmanAi/mmos (Privado + NDA)
...
| 1.1     | 2025-12-14 | Actualizada org a MarkmanAi, reemplazados Paquetes de Expansion con sistema de Squads [Story 6.10] | Dex (dev)        |
