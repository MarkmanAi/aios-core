...
Esta es una nueva implementación MVP de la capa de memoria para MarkmanAi AIOS, diseñada como una prueba de concepto liviana que puede integrarse fácilmente con el sistema de agentes existente. El MVP usa LlamaIndex con almacenamiento local para minimizar la complejidad de configuración.
