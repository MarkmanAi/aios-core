...
# Guia de Actualizacion de MarkmanAi AIOS

> 🌐 [EN](../migration-guide.md) | [PT](../pt/migration-guide.md) | **ES**

---

Esta guia te ayuda a actualizar entre versiones de MarkmanAi AIOS.
...
**MarkmanAi AIOS v4.4.0** (Version Estable Actual)
...
npm list @markmanai/aios-core/core > ../backups/version-info.txt
...
npm install -g @markmanai/aios-core@latest
...
cd your-project
npm update @markmanai/aios-core/core

# Reinstalar dependencias
npm install

# Verificar actualizacion
npm list @markmanai/aios-core/core
```
...
npm install -g @markmanai/aios-core@<previous-version>
...
npm install -g @markmanai/aios-core@latest --verbose
...
2. **GitHub Issues**: [github.com/MarkmanAi/aios-core/issues](https://github.com/MarkmanAi/aios-core/issues)
