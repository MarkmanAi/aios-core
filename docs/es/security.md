...
Tomamos la seguridad en serio en MarkmanAi. Si descubres una vulnerabilidad de seguridad en AIOS, por favor repórtala de manera responsable.
...
1. **GitHub Security Advisories** (Preferido)
   - Ve a [Security Advisories](https://github.com/MarkmanAi/aios-core/security/advisories)
   - Haz clic en "Report a vulnerability"
   - Completa el formulario con los detalles

2. **Email**
   - Envía un email a: security@markmanai.com
...
- [GitHub Security Advisories](https://github.com/MarkmanAi/aios-core/security/advisories)
