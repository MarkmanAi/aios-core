...
# Primeros Pasos con MarkmanAi AIOS

> 🌐 [EN](../getting-started.md) | [PT](../pt/getting-started.md) | **ES**

---

Bienvenido a MarkmanAi AIOS! Esta guia te llevara a traves de tus primeros pasos con el framework de desarrollo auto-modificable impulsado por IA.
...
Antes de instalar MarkmanAi AIOS, asegurate de tener:
...
MarkmanAi AIOS ofrece opciones de instalacion flexibles:
...
El meta-agente es el nucleo de MarkmanAi AIOS - una IA que entiende y puede modificar su propia base de codigo.
...
- **[Tutoriales en Video](https://@markmanai/aios-core.dev/tutorials)**: Aprendizaje visual
...
Recuerda: MarkmanAi AIOS aprende y mejora con el uso. Cuanto mas interactues con el, mejor entendera tu estilo de desarrollo y necesidades.

Feliz programacion con MarkmanAi AIOS!
