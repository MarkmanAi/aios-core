...
> Para seguimiento detallado, consulta nuestro [Proyecto de GitHub](https://github.com/orgs/MarkmanAi/projects/1)
...
Reacciona con :+1: en [Ideas en Discussions](https://github.com/MarkmanAi/aios-core/discussions/categories/ideas) existentes para mostrar apoyo.

### 2. Propón Características

¿Tienes una nueva idea? Abre una [Discusión de Idea](https://github.com/MarkmanAi/aios-core/discussions/new?category=ideas) para compartirla con la comunidad.
...
5. Comunicar cambios significativos vía [Anuncios](https://github.com/MarkmanAi/aios-core/discussions/categories/announcements)
...
|----------------|-------------------|
| [Proyecto de GitHub](https://github.com/orgs/MarkmanAi/projects/1) | `docs/stories/backlog.md` |
