...
MarkmanAi AIOS puede instalarse via NPX para una configuración rápida sin instalación global. Esta guía cubre el uso correcto y la resolución de problemas para instalaciones basadas en NPX.
...
NPX ejecuta paquetes en **directorios temporales** (por ejemplo, `/private/var/folders/.../npx-xxx/` en macOS). Cuando MarkmanAi AIOS se ejecuta desde estas ubicaciones temporales, no puede:
...
A partir de la versión 4.31.1, MarkmanAi AIOS detecta automáticamente cuando está ejecutándose desde un directorio temporal NPX y muestra un mensaje de error útil:
...
MarkmanAi AIOS detecta estos patrones y previene instalaciones incorrectas.
...
MarkmanAi AIOS v4.31.1+ implementa detección de dos capas:
