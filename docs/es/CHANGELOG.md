...
Todos los cambios notables en MarkmanAi AIOS seran documentados en este archivo.
...
- Proceso de instalacion manual (usar `npx @markmanai/aios-core install` en su lugar)
...
- Lanzamiento publico inicial de MarkmanAi AIOS
...
- [Repositorio GitHub](https://github.com/MarkmanAi/aios-core)
