...
| ----------------- | ------- | ------------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Recoleccion y transformacion de datos | [aios-squads/etl](https://github.com/MarkmanAi/aios-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Utilidades de generacion de contenido | [aios-squads/creator](https://github.com/MarkmanAi/aios-squads/tree/main/creator) |
...
- **Explorar Squads Oficiales:** Revisar [repositorio aios-squads](https://github.com/MarkmanAi/aios-squads)
...
**Squads** son el nuevo estandar (AIOS 2.1+) reemplazando Expansion Packs. Los Squads tienen:
