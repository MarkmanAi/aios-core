...
Guia completa para desarrolladores que quieren contribuir al proyecto MarkmanAi AIOS.
...
1. Navega a [github.com/MarkmanAi/aios-core](https://github.com/MarkmanAi/aios-core)
...
- Etiquetar `@MarkmanAi/core-team` para issues urgentes
...
_MarkmanAi AIOS Guia de Configuracion para Desarrollo v1.0.0_
