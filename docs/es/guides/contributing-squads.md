...
Como contribuir squads al ecosistema AIOS.
...
Esto:
1. Hara fork de `MarkmanAi/aios-squads` (si es necesario)
...
- **Preguntas**: [Discusiones de GitHub](https://github.com/MarkmanAi/aios-core/discussions)
- **Issues**: [Rastreador de Issues](https://github.com/MarkmanAi/aios-core/issues)
