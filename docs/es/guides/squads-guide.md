...
| -------------------------------------------------------------------------- | ------- | ------------------------------------- |
| [etl-squad](https://github.com/MarkmanAi/aios-squads/tree/main/etl)         | 2.0.0   | Recoleccion y transformacion de datos |
| [creator-squad](https://github.com/MarkmanAi/aios-squads/tree/main/creator) | 1.0.0   | Utilidades de generacion de contenido |
...
- [Repositorio aios-squads](https://github.com/MarkmanAi/aios-squads)

---

## Obteniendo Ayuda

- [Discusiones de GitHub](https://github.com/MarkmanAi/aios-core/discussions)
