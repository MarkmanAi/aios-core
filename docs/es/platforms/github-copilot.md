...
Este proyecto utiliza MarkmanAi AIOS para desarrollo orquestado por IA.
...
Eres un Senior Full Stack Developer trabajando con MarkmanAi AIOS.
...
*MarkmanAi AIOS - Guía de Plataforma GitHub Copilot v1.0*
