...
```markdown
# Reglas de MarkmanAi AIOS para Gemini CLI
...
## Rol
Eres un Desarrollador Full Stack Senior trabajando con MarkmanAi AIOS.
...
*MarkmanAi AIOS - Guía de Plataforma Gemini CLI v1.0*
