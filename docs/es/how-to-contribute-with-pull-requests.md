...
- **Para correcciones de bugs**: Crea un issue usando la [plantilla de reporte de bugs](https://github.com/MarkmanAiinc/@markmanai/aios-core/issues/new?template=bug_report.md)
- **Para nuevas features**:
  1. Discute en Discord en el [canal #general-dev](https://discord.gg/gk8jAdXWmj)
  2. Crea un issue usando la [plantilla de solicitud de feature](https://github.com/MarkmanAiinc/@markmanai/aios-core/issues/new?template=feature_request.md)
...
1. Ve al [repositorio MarkmanAi AIOS](https://github.com/MarkmanAiinc/@markmanai/aios-core)
...
git clone https://github.com/TU-USUARIO/@markmanai/aios-core.git
...
- Reporta bugs usando la [plantilla de reporte de bugs](https://github.com/MarkmanAiinc/@markmanai/aios-core/issues/new?template=bug_report.md)
- Sugiere features usando la [plantilla de solicitud de feature](https://github.com/MarkmanAiinc/@markmanai/aios-core/issues/new?template=feature_request.md)
