...
**Aviso de Migración:** Este documento migrará al repositorio `MarkmanAi/aios-core` en Q2 2026 (ver Decision 005)
...
| 1.1     | 2025-12-14 | Actualizado aviso de migración a MarkmanAi/aios-core, semantic-release a v25.0.2 [Story 6.10] | Dex (dev)        |
