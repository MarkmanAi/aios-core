...
This is a new MVP implementation of the memory layer for MarkmanAi AIOS, designed as a lightweight proof of concept that can be easily integrated with the existing agent system. The MVP uses LlamaIndex with local storage to minimize setup complexity.
