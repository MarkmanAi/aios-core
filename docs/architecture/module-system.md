...
> **EN** | [PT](../pt/architecture/module-system.md) | [ES](../es/architecture/module-system.md)

---

> Comprehensive guide to the v2.1 modular architecture for MarkmanAi AIOS.
...
MarkmanAi AIOS organizes the `.aios-core/` directory into four primary modules:
...
_MarkmanAi AIOS v2.1 Module System Architecture_
