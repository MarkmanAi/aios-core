...
AIOS (AI-Orchestrated System) is an open-source project maintained by MarkmanAi Inc. This privacy policy explains how we handle any data that may be collected when you use MarkmanAi AIOS.

## Data Collection

### What We Don't Collect

MarkmanAi AIOS does **NOT** collect:
...
MarkmanAi AIOS uses a **consent-based telemetry system**. The system is designed as follows:
...
MarkmanAi AIOS stores some data locally on your machine:
...
When using MarkmanAi AIOS, you may interact with third-party services:
...
**Important:** Your interactions with these services are governed by their respective privacy policies. MarkmanAi AIOS does not control or have access to data you share with these services.
...
- Repository: [github.com/MarkmanAi/aios-core](https://github.com/MarkmanAi/aios-core)
- No hidden data collection mechanisms
- All configuration options are documented

## Children's Privacy

MarkmanAi AIOS is a development tool intended for professional use. We do not knowingly collect any information from children under 13 years of age.
...
For security vulnerabilities, please [open an issue](https://github.com/MarkmanAi/aios-core/issues) or email security@MarkmanAi.com.
...
**Copyright (c) 2025 MarkmanAi Inc.**
