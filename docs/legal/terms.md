...
By using MarkmanAi AIOS ("the Software"), you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the Software.

## License

MarkmanAi AIOS is released under the **MIT License**. See the [LICENSE](LICENSE) file for the full license text.
...
- ❌ Use MarkmanAi Inc. trademarks without written permission
- ❌ Hold the authors or copyright holders liable for any damages
- ❌ Claim authorship or endorsement by MarkmanAi Inc.
...
IN NO EVENT SHALL THE AUTHORS, COPYRIGHT HOLDERS, OR YAHWEH GROUP BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.
...
By contributing to MarkmanAi AIOS, you agree that:
...
The following are trademarks or registered trademarks of MarkmanAi Inc.:
...
For trademark licensing inquiries, contact: legal@MarkmanAi.com

## Third-Party Dependencies

MarkmanAi AIOS includes third-party open-source components. Each component is subject to its own license terms:
...
When using AI providers (Claude, OpenAI, etc.) through MarkmanAi AIOS:
...
These Terms of Use, together with the [LICENSE](LICENSE), [Privacy Policy](PRIVACY.md), and [Code of Conduct](CODE_OF_CONDUCT.md), constitute the entire agreement between you and MarkmanAi Inc. regarding use of MarkmanAi AIOS.

## Contact

For questions about these terms:

- **GitHub Issues:** [Open an issue](https://github.com/MarkmanAi/aios-core/issues)
- **Email:** legal@MarkmanAi.com
- **Discord:** [Community Server](https://discord.gg/gk8jAdXWmj)

---

**Copyright (c) 2025 MarkmanAi Inc. All rights reserved.**
