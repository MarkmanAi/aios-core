...
1. **aios-squads Repository** - Free, open-source squads on GitHub
2. **MarkmanAi Marketplace** - Premium squads via MarkmanAi API
...
This will:
1. Fork `MarkmanAi/aios-squads` (if needed)
...
## Publishing to MarkmanAi Marketplace
...
- **Questions**: [GitHub Discussions](https://github.com/MarkmanAi/aios-core/discussions)
- **Issues**: [Issue Tracker](https://github.com/MarkmanAi/aios-core/issues)
