...
|-------|---------|-------------|
| [etl-squad](https://github.com/MarkmanAi/aios-squads/tree/main/etl) | 2.0.0 | Data collection and transformation |
| [creator-squad](https://github.com/MarkmanAi/aios-squads/tree/main/creator) | 1.0.0 | Content generation utilities |
...
This creates a PR to [MarkmanAi/aios-squads](https://github.com/MarkmanAi/aios-squads).

### Level 3: MarkmanAi Marketplace
...
3. Re-publish: `*publish-squad` or `*sync-squad-markmanai`
...
- **Level 3**: Sync with `--private` flag: `*sync-squad-markmanai my-squad --private`
...
- [aios-squads Repository](https://github.com/MarkmanAi/aios-squads)
