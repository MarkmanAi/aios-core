...
const TROUBLESHOOTING_DATABASE = {
  ENV_FILE_MISSING: {
    ...
    solutions: [
      'Re-run wizard: npx @MarkmanAi/aios@latest init',
      'Manually create .env from template: cp .env.example .env',
      'Check file permissions in project directory',
    ],
    docs: 'https://docs.MarkmanAi.com/installation/environment',
    priority: 'critical',
  },
  ...
  CORE_CONFIG_MISSING: {
    ...
    docs: 'https://docs.MarkmanAi.com/configuration/core-config',
    priority: 'high',
  },
  ...
  MCP_HEALTH_CHECK_FAILED: {
    ...
    docs: 'https://docs.MarkmanAi.com/mcps/troubleshooting',
    priority: 'medium',
  },
  ...
  GITIGNORE_CRITICAL_MISSING: {
    ...
    docs: 'https://docs.MarkmanAi.com/security/gitignore',
    priority: 'high',
  },
  ...
  DEPS_INSTALL_FAILED: {
    ...
    docs: 'https://docs.MarkmanAi.com/installation/dependencies',
    priority: 'critical',
  },
  ...
  ENV_PERMISSIONS_INSECURE: {
    ...
    docs: 'https://docs.MarkmanAi.com/security/file-permissions',
    priority: 'medium',
  },
};
...
async function offerTroubleshooting(errors) {
  ...
  if (viewLogs) {
    ...
    console.log(chalk.dim('  - .aios/install-log.txt'));
    console.log(chalk.dim('  - .aios/install-errors.log'));
    console.log('');
    console.log(chalk.dim('View with: cat .aios/install-log.txt'));
  }
  ...
  if (openDocs) {
    ...
    console.log(chalk.green('  https://docs.MarkmanAi.com/troubleshooting'));
    console.log('');
  }
  ...
  console.log(chalk.dim('  - GitHub Issues: https://github.com/MarkmanAi/aios/issues'));
  console.log(chalk.dim('  - Documentation: https://docs.MarkmanAi.com'));
  console.log('');
}
...
function displayGenericTroubleshooting(code, errorInstances) {
  ...
  console.log(chalk.green('  2. Check installation logs in .aios/'));
