...
IDE-FILE-RESOLUTION:
  - FOR LATER USE ONLY
  - Dependencies map to squads/sop-factory/{type}/{name}
...
routing_matrix:
  ...
  certify: "sop-auditor"
  comply: "sop-auditor"
  convert: "sop-creator + sop-ml-architect (pipeline)"
...
dependencies:
  ...
  checklists: []
  data: []
  # NOTE: sop-chief routes inline via routing_matrix — no task files required.
  # Specialist tasks live in their respective agent files.
```
