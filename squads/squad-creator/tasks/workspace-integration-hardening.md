...
```bash
bash squads/squad-creator/scripts/validate-squad.sh {squad_name}
python3 squads/squad-creator/scripts/validate-workspace-contract.py {squad_name} --strict --report outputs/squad_upgrade/{squad_name}/workspace-hardening-audit.yaml
```
...
```bash
bash squads/squad-creator/scripts/validate-squad.sh {squad_name}
python3 squads/squad-creator/scripts/validate-workspace-contract.py {squad_name} --strict --report outputs/squad_upgrade/{squad_name}/workspace-hardening-final.yaml
```
