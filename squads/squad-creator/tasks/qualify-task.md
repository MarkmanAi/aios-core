...
|----|-----------|-------|--------|
| VETO-QFT-001 | Task file must exist before qualification can proceed | Verify file exists at squads/squad-creator/tasks/{task_name}.md | VETO - BLOCK. Task not found in squad task catalog. |
